...
def bfs(tube_dict:dict, start_station:str, end_station:str, reversed:bool=False):
	...
	while agenda:
		...
		for child in child_nodes:
			...
			if station not in explored:
				agenda.append({"current": {"station": station},
...
if __name__ == "__main__":
	...
	# Run search
	# stations_expanded, node = bfs(tube_dict=station_dict, start_station="Wembley Central", end_station="Harrow & Wealdstone")
	stations_expanded, node = bfs(tube_dict=station_dict, start_station="Ealing Broadway", end_station="South Kensington")
